...
Status: planned deployment shell.

Owns unprivileged Node.js containers, local dependency Compose, production
self-hosted composition, health checks, and deployment conformance.
