...
| RUN-T04 | Node singleton becomes authoritative cache/session/lock | Critical | Stateless-service source gate, exact replica-state probes, no local outage fallback, built-Docker multi-instance/restart/eviction tests | Low |
